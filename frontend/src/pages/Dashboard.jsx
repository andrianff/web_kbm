  ...
  return (
    <>
      <div className="stats-grid">
        <Link to="/kelola-penghuni" className="stat-card purple" style={{ textDecoration: 'none' }}>
        ...
        <Link to="/kelola-ruangan" className="stat-card cyan" style={{ textDecoration: 'none' }}>
        ...
        <div className="card">
          ...
          <div className="pengumuman-list">
            {stats.pengumuman_terbaru.map(p => (
              <div key={p.id} className={`pengumuman-card ${p.is_pinned ? 'pinned' : ''} ${p.prioritas}`}>
...
function PenghuniDashboard({ stats }) {
  return (
    <>
      <div className="stats-grid">
        <Link to="/booking-ruangan" className="stat-card purple" style={{ textDecoration: 'none' }}>
          <div className="stat-icon purple">📅</div>
          <div className="stat-info">
        ...
        <Link to="/tagihan" className="stat-card red" style={{ textDecoration: 'none' }}>
          <div className="stat-icon red">💰</div>
          <div className="stat-info">
        ...
        <Link to="/tagihan" className="stat-card orange" style={{ textDecoration: 'none' }}>
          <div className="stat-icon orange">💵</div>
          <div className="stat-info">
        ...
        <Link to="/laporan" className="stat-card cyan" style={{ textDecoration: 'none' }}>
          <div className="stat-icon cyan">🔧</div>
          <div className="stat-info">
        ...
        <Link to="/uang-kas" className="stat-card green" style={{ textDecoration: 'none' }}>
          <div className="stat-icon green">💵</div>
          <div className="stat-info">
            <h3>{stats.iuran_belum_bayar || 0}</h3>
            <p>Iuran Kas Belum Bayar</p>
          </div>
        </Link>
      </div>
